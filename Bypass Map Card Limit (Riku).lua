...
LUAGUI_DESC = "Gives Riku 99 of Moment's Reprieve #1, #2, and #3, bypassing the 99 map card limit. Original 'All Map Cards' mod by KSX."
...
if ReadByte(DReportMapCardFlags+13, true) <= 1 then -- Moment´s Reprieve
	WriteByte(DReportMapCardFlags+13, 4, true)
end
